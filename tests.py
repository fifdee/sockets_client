...
class CommandManagerTest(unittest.TestCase):
    ...
    def test_adding_login_credentials_to_command(self):
        ...
        self.assertEqual('whisper username1 password1 another_user message', CommandManager.login_command)
